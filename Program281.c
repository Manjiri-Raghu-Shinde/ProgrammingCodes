...
int main()
{
    ...
    printf("Welcome to the data structure application written ny miss Manjiri Shinde\n");
    while(1)
    {
        printf("------------------------------------------------\n");
        
        
        printf("1 : Insert a new node at First Position\n");
        printf("2 : Insert a new node at Last Position\n");
        printf("3 : Insert a new node at Given Position\n");
        printf("4 : Delete a node from First Position\n");
        printf("5 : Delete a node from Last Position\n");
